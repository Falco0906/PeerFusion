        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-24 right-6 z-[9989] w-[420px] h-[650px] max-h-[calc(100vh-120px)] bg-background rounded-2xl shadow-2xl border border-border overflow-hidden flex flex-col"
              style={{
